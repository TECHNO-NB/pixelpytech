    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <br />
          <span className="text-white/90">Inspire</span>
        </motion.h1>
        ...
        >
          Pixelpy Tech crafts world-class websites and mobile applications — 
          where stunning design meets flawless engineering.
        </motion.p>
